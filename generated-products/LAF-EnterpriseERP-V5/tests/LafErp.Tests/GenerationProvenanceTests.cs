...
public class GenerationProvenanceTests
{
    ...
    public void Generated_catalog_entities_exist_in_assembly()
    {
        ...
        Assert.NotNull(typeof(LafErp.Core.EntityBase).Assembly.GetType("LafErp.Core.CreditNote"));
        ...
        Assert.NotNull(typeof(LafErp.Core.EntityBase).Assembly.GetType("LafErp.Core.DebitNote"));
        Assert.NotNull(typeof(LafErp.Core.EntityBase).Assembly.GetType("LafErp.Core.StockTransfer"));
        Assert.NotNull(typeof(LafErp.Core.EntityBase).Assembly.GetType("LafErp.Core.StockReconciliation"));
        Assert.NotNull(typeof(LafErp.Core.EntityBase).Assembly.GetType("LafErp.Core.PriceList"));
        ...
        Assert.NotNull(typeof(LafErp.Core.EntityBase).Assembly.GetType("LafErp.Core.JobCard"));
        ...
        Assert.NotNull(typeof(LafErp.Core.EntityBase).Assembly.GetType("LafErp.Core.LeaveApplication"));
