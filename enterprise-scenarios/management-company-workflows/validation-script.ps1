<# R2-ACC-INDUSTRIAL: lightweight validation for the management-company-workflows scenario. This scenario
...
if ($ok) { Write-Host "management-company-workflows: scenario assets present." -ForegroundColor Green; exit 0 }
else { Write-Host "management-company-workflows: missing assets." -ForegroundColor Red; exit 1 }
